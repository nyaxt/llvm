...
#include "NkmmGenDAGISel.inc"
  ...
  bool selectAddrRegWithImmOffset(SDValue Addr, SDValue &Base,
...
bool NkmmDAGToDAGISel::selectAddrRegWithImmOffset(SDValue Addr, SDValue &Base,
                                                  SDValue &Offset) const {
...
SDNode *NkmmDAGToDAGISel::Select(SDNode *Node) {
