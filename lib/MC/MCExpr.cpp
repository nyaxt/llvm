...
StringRef MCSymbolRefExpr::getVariantKindName(VariantKind Kind) {
  ...
  case VK_Nkmm_GPREL: return "GPREL";
  case VK_Nkmm_GOT_CALL: return "GOT_CALL";
  case VK_Nkmm_GOT16: return "GOT16";
  case VK_Nkmm_GOT: return "GOT";
  case VK_Nkmm_ABS_HI: return "ABS_HI";
  case VK_Nkmm_ABS_LO: return "ABS_LO";
  case VK_Nkmm_TLSGD: return "TLSGD";
  case VK_Nkmm_TLSLDM: return "TLSLDM";
  case VK_Nkmm_DTPREL_HI: return "DTPREL_HI";
  case VK_Nkmm_DTPREL_LO: return "DTPREL_LO";
  case VK_Nkmm_GOTTPREL: return "GOTTPREL";
  case VK_Nkmm_TPREL_HI: return "TPREL_HI";
  case VK_Nkmm_TPREL_LO: return "TPREL_LO";
  case VK_Nkmm_GPOFF_HI: return "GPOFF_HI";
  case VK_Nkmm_GPOFF_LO: return "GPOFF_LO";
  case VK_Nkmm_GOT_DISP: return "GOT_DISP";
  case VK_Nkmm_GOT_PAGE: return "GOT_PAGE";
  case VK_Nkmm_GOT_OFST: return "GOT_OFST";
  case VK_Nkmm_HIGHER:   return "HIGHER";
  case VK_Nkmm_HIGHEST:  return "HIGHEST";
  case VK_Nkmm_GOT_HI16: return "GOT_HI16";
  case VK_Nkmm_GOT_LO16: return "GOT_LO16";
  case VK_Nkmm_CALL_HI16: return "CALL_HI16";
  case VK_Nkmm_CALL_LO16: return "CALL_LO16";
  case VK_Nkmm_PCREL_HI16: return "PCREL_HI16";
  case VK_Nkmm_PCREL_LO16: return "PCREL_LO16";
